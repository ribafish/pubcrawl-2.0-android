...
public class PersonDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.popup_person, container, false);
        ...
        this.participantAdapter = new ParticipantAdapter(context, this.participantsDiplayed);
        participantsListView.setAdapter(this.participantAdapter);
        ...
        toolbar.inflateMenu(R.menu.popup_person_menu);
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.popup_person_menu_close:
                        dismiss();
                        break;
                    case R.id.popup_person_menu_search:
